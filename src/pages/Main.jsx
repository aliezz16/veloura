...
function Main() {
  ...
  const handleSubmit = (e) => {
    ...
    if (name.trim() === "" || message.trim() === "") {
      ...
      const phoneNumber = "96181819170"; // Replace with your target phone number
          ...
          <div className="flex flex-col lg:flex-row items-center mt-10 space-y-8 md:space-y-0 md:space-x-12">
            ...
            <div className="flex flex-1 flex-col space-y-6 text-center md:text-left">
              ...
              <p className="text-sm md:text-lg text-[#443] leading-relaxed">
                At our dessert shop, we’re all about simple pleasures and sweet
                moments. Try our creamy Lotus Cheesecake, rich Tiramisu, classic
                Strawberry Cheesecake, or the fun and trendy Lazy Cat dessert.
                Each one is made with care and top-quality ingredients to make
